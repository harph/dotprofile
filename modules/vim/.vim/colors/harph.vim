...
hi Normal       guifg=#ff0000   guibg=#303030   ctermfg=188    ctermbg=236       gui=none      cterm=none

hi Comment      guifg=#ff0000   guibg=NONE      ctermfg=244    ctermbg=NONE      gui=none      cterm=none

hi Constant     guifg=#ff0000   guibg=NONE      ctermfg=187    ctermbg=NONE      gui=none      cterm=none
hi BConstant    guifg=#d7d7af   guibg=NONE      ctermfg=187    ctermbg=NONE      gui=bold      cterm=bold

hi Identifier   guifg=#ff0000   guibg=NONE      ctermfg=150    ctermbg=NONE      gui=none      cterm=none
hi BIdentifier  guifg=#afd787   guibg=NONE      ctermfg=150    ctermbg=NONE      gui=bold      cterm=bold

hi Statement    guifg=#ff0000   guibg=NONE      ctermfg=117    ctermbg=NONE      gui=none      cterm=none
hi BStatement   guifg=#0033FF   guibg=NONE      ctermfg=117    ctermbg=NONE      gui=bold      cterm=bold
...
hi Type         guifg=#ff0000   guibg=NONE      ctermfg=116    ctermbg=NONE      gui=none      cterm=none
hi BType        guifg=#87d7d7   guibg=NONE      ctermfg=116    ctermbg=NONE      gui=bold      cterm=bold

hi Special      guifg=#ff0000   guibg=NONE      ctermfg=182    ctermbg=NONE      gui=none      cterm=none
...
hi Todo         guifg=#ff0000   guibg=#ff0000   ctermfg=185    ctermbg=58        gui=none      cterm=none
